...
export const WhiteboardCanvas: FunctionComponent<Props> = ({
  ...
  const { width, height /* left, top */ } = useFixedAspectScaling(
  ...
  // /**
  //  * ! Is modified
  //  * !!!!!!!! Add code related to custom brushes
  ...
  //     // Escape - Cancel Textbox creation
  //     if ((e as ICanvasKeyboardEvent).key === 'Escape' && canvas) {
  //       canvas.discardActiveObject();
  //       canvas.renderAll();
  //     }

  //     // Shift - Perfect Shape Creation
  //     if (
  //       (e as ICanvasKeyboardEvent).key === 'Shift' &&
  //       canvas &&
  //       !perfectShapeIsActive &&
  ...
  // // Laser Feature, maybe could be on variable declation on top of the file
  // /**
  //  * Memoized laserIsActive prop.
  //  */
  // const laserPointerIsActive = useMemo(() => laserIsActive, [laserIsActive]);
  ...
  // Event Synchronization, maybe could be here but in the top
  ...
  /**
   * !! Is Modified
   * !!!! Add logic about custom brushes
  ...
  // !! Is modified
  // !!!!! Add logic related to custom brushes
  // useEffect(() => {
  //   if (lineWidth && canvas) {
  //     const obj = canvas.getActiveObject() as ICanvasObject;
