...
export const WhiteboardProvider = ({
  ...
  const [displayUserInfo, setUserInfoToDisplay] = useState(TOOLBAR_DEFAULT_VALUES.DISPLAY_USER_INFO_OPTION);
  const {
  ...
  const [selectedTool, updateSelectedTool] = useState(TOOLBAR_DEFAULT_VALUES.SELECTED_TOOL);
