...
export interface IPainterController {
  on(
    ...
    listener: (id: string, generatedBy: string, objectType: string, target: ICanvasObject) => void
  ): this;
  removeListener(
    event: PainterEventType,
    listener: (id: string, generatedBy: string, objectType: string, target: ICanvasObject) => void
  ...
  on(
    event: 'skewed',
    listener: (id: string, generatedBy: string, target: ICanvasObject) => void
  ): this;
  on(
    event: 'colorChanged',
    listener: (id: string, generatedBy: string, objectType: string, target: ICanvasObject) => void
  ...
  on(
    event: 'removed',
    listener: (id: string, generatedBy: string, permission: boolean) => void
  ): this;
  on(
    event: 'reconstruct',
    listener: (id: string, generatedBy: string, target: ICanvasObject) => void
