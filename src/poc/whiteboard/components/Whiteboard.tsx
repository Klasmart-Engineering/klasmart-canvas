...
export function Whiteboard({ children, containerWidth, containerHeight, height, filterUsers }: Props): JSX.Element {
    ...
    return (
        <div style={{position:"relative", width: containerWidth || "100%", height: containerHeight}}>
