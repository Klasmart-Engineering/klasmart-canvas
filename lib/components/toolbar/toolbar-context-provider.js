...
export default function ToolbarContextProvider(_a) {
    ...
    return (React.createElement(Context.Provider, { value: { state: { tools: toolsLookup, colors: Array.from(colors.values()), thickness: Array.from(thickness.values()) }, status: status, actions: actions } }, children));
}
