...
export default function ToolbarContextProvider(_a) {
    ...
    var selectColorAction = useCallback(function (color) {
    ...
    var clearAction = useCallback(function (_filter) {
        clearWhiteboard();
    }, [clearWhiteboard]);
