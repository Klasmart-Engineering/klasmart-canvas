...
function ToolbarSelector(props) {
    ...
    return (React.createElement("div", { className: "selector-container", style: selectorContainerStyle },
        React.createElement("button", { title: selectedOption.title, ref: buttonRef, style: toolbarSelectorStyle, className: [
            ...
            React.createElement("img", { className: "icon", style: iconStyle, src: selectedOption.iconSrc, alt: selectedOption.iconName, onClick: handleClick }),
            React.createElement(ArrowRightIcon, { className: "arrow", onClick: handleArrowClick, style: arrowStyle })),
        showOptions && active ? (React.createElement("div", { className: "options-container", style: optionsContainerStyle },
            React.createElement("div", { style: optionsStyle, className: [
                    'options',
