 ...
 */
export var rectangle = function (width, height, color) {
 ...
 * @param color Color of shape
 */
export var triangle = function (width, height, color) {
 ...
 * @param color Color of shape
 */
export var circle = function (width, height, color) {
 ...
 * @param color Color of shape
 */
export var pentagon = function (color) {
 ...
 * @param color Color of shape
 */
export var hexagon = function (color) {
    var shape = new fabric.Polygon([
        { x: 125, y: 0 },
        { x: 275, y: 0 },
        { x: 350, y: 175 },
 ...
 * @param color Color of shape.
 */
export var generic = function (path, width, height, color) {
    var shape = new fabric.Path(path);
    var scaleX = 1 / (shape.width / width);
    var scaleY = 1 / (shape.height / height);
    return shape.set({ scaleX: scaleX, scaleY: scaleY, fill: color });
};
/**
 ...
 * @param color Color of shape
 */
export var star = function (width, height, color) {
 ...
 * @param color Color of shape
 */
export var arrow = function (width, height, color) {
 ...
 * @param color Color of shape
 */
export var chat = function (width, height, color) {
