...
export var WhiteboardProvider = function (_a) {
    ...
    return (React.createElement(WhiteboardContext.Provider, { value: value },
        React.createElement("button", { onClick: function () { return clearWhiteboardActionClearMyself(); } }, "Clear My self"),
        React.createElement("button", { onClick: function () { return clearWhiteboardActionClearAll(); } }, "Clear All"),
        React.createElement("button", { onClick: function () { return clearWhiteboardAllowClearOthersAction('student'); } }, "Clear student"),
