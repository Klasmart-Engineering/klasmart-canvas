...
export var WhiteboardProvider = function (_a) {
    ...
    var _u = useToolbarPermissions(), toolbarIsEnabled = _u.toolbarIsEnabled, setToolbarIsEnabled = _u.setToolbarIsEnabled;
    // Provisional (just for change value in Toolbar selectors) they can be modified in the future
    var _v = useState(DEFAULT_VALUES.POINTER), pointer = _v[0], updatePointer = _v[1];
    var _w = useState(DEFAULT_VALUES.PEN_LINE), penLine = _w[0], updatePenLine = _w[1];
    var _x = useState(DEFAULT_VALUES.PEN_COLOR), penColor = _x[0], updatePenColor = _x[1];
    var _y = useState(DEFAULT_VALUES.STAMP), stamp = _y[0], updateStamp = _y[1];
    ...
    // apply action to.
    var _z = useState(), canvasActions = _z[0], updateCanvasActions = _z[1];
    ...
    var _0 = useState(true), eventedObjects = _0[0], updateEventedObjects = _0[1];
