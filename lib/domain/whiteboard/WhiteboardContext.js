...
export var WhiteboardProvider = function (_a) {
    ...
    // apply action to.
    var _0 = useState(), canvasActions = _0[0], updateCanvasActions = _0[1];
    ...
    var clear = useCallback(function (filterUsers) {
        canvasActions === null || canvasActions === void 0 ? void 0 : canvasActions.clear(filterUsers);
    }, [canvasActions]);
    var clearSelf = useCallback(function () {
        canvasActions === null || canvasActions === void 0 ? void 0 : canvasActions.clearSelf();
    }, [canvasActions]);
