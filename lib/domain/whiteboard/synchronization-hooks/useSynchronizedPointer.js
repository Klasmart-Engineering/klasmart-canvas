 ...
 */
var useSynchronizedPointer = function (canvas, showPointer, universalPermits, shouldHandleRemoteEvent, userId, laserColor, laserIsActive, allowPointer, generatedBy) {
    ...
    useEffect(function () {
         ...
         */
        var moved = function (id, generatedBy, target) {
