...
var useSynchronizedScaled = function (canvas, userId, shouldSerializeEvent, shouldHandleRemoteEvent, undoRedoDispatch) {
    ...
    useEffect(function () {
        ...
        (_a = eventController) === null || _a === void 0 ? void 0 : _a.on('scaled', scaled);
        return function () {
            var _a;
            (_a = eventController) === null || _a === void 0 ? void 0 : _a.removeListener('scaled', scaled);
        };
    ...
    useEffect(function () {
        ...
        (_a = canvas) === null || _a === void 0 ? void 0 : _a.on('object:scaled', objectScaled);
        return function () {
            var _a;
            (_a = canvas) === null || _a === void 0 ? void 0 : _a.off('object:scaled', objectScaled);
        };
