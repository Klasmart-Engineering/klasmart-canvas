...
var useSynchronizedScaled = function (canvas, userId, generatedBy, shouldSerializeEvent, shouldHandleRemoteEvent, undoRedoDispatch) {
    ...
    useEffect(function () {
        var scaled = function (id, generatedBy, objectType, target) {
        ...
        var objectScaled = function (e) {
            ...
            if (type === 'activeSelection' && e.target._objects) {
                ...
                groupObjects.forEach(function (activeObject) {
                    if (!activeObject.id)
                        throw new Error('Scaled object without id');
                    if (!activeObject.generatedBy)
                        throw new Error('Scaled object without generatedBy');
                    ...
                    eventSerializer === null || eventSerializer === void 0 ? void 0 : eventSerializer.push('scaled', generatedBy, payload);
                });
                var payload = {
                    type: type,
                    svg: true,
