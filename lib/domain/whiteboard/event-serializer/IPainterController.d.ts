...
export interface IPainterController {
    ...
    on(event: 'scaled', listener: (id: string, objectType: string, target: any) => void): this;
    ...
    removeListener(event: 'scaled', listener: (id: string, objectType: string, target: any) => void): this;
    ...
    removeListener(event: 'reconstruct', listener: (id: string, target: any) => void): this;
