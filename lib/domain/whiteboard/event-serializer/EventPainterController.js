...
var EventPainterController = /** @class */ (function (_super) {
    ...
    EventPainterController.prototype.moved = function (id, target) {
        this.emit('moved', id, target);
    };
    EventPainterController.prototype.rotated = function (id, target) {
        this.emit('rotated', id, target);
    };
    EventPainterController.prototype.scaled = function (id, target) {
    ...
    EventPainterController.prototype.removed = function (id) {
