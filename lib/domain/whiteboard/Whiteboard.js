        ...
        React.createElement(WhiteboardProvider, { clearWhiteboardPermissions: student },
            React.createElement("div", { className: "whiteboard" },
                ...
                React.createElement("div", { style: {
                    ...
                    React.createElement(WhiteboardCanvas, { instanceId: "canvas3", userId: "studen2", initialStyle: canvasStyle, pointerEvents: true, width: 740, height: 460, cssWidth: '740px', cssHeight: '460px' },
                        React.createElement("button", null, "Student")))))));
}
