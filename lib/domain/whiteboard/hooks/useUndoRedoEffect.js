 ...
 * @param canvasId Canvas ID
 */
export var UndoRedo = function (canvas, eventSerializer, instanceId) {
        ...
        if (state.actionType === UNDO) {
            ...
            if (nextEvent.type === 'added') {
                ...
                if ((nextEvent === null || nextEvent === void 0 ? void 0 : nextEvent.event).type === 'background') {
                    ...
                    eventSerializer === null || eventSerializer === void 0 ? void 0 : eventSerializer.push('reconstruct', payload_1);
                    return;
                }
                ;
                if (currentEvent && currentEvent.type !== 'activeSelection' && currentEvent.type !== 'remove') {
                    ...
                    eventSerializer === null || eventSerializer === void 0 ? void 0 : eventSerializer.push('reconstruct', payload_2);
                }
                    ...
                    eventSerializer === null || eventSerializer === void 0 ? void 0 : eventSerializer.push('reconstruct', payload_3);
                }
            }
            else {
                if ((state.events[state.eventIndex].type === 'activeSelection' &&
                    ...
                    eventSerializer === null || eventSerializer === void 0 ? void 0 : eventSerializer.push('reconstruct', payload_4);
                }
                else {
                    var objects = JSON.parse(state.states[state.activeStateIndex]).objects;
                    var payload_5 = {
                    ...
                    eventSerializer === null || eventSerializer === void 0 ? void 0 : eventSerializer.push('reconstruct', payload_5);
                }
            }
        }
            ...
            if (event_1.type === 'added') {
                eventSerializer === null || eventSerializer === void 0 ? void 0 : eventSerializer.push('added', event_1.event);
            }
            else if (event_1.type === 'removed') {
                eventSerializer === null || eventSerializer === void 0 ? void 0 : eventSerializer.push('removed', { id: event_1.event.id });
            }
