...
export var WhiteboardCanvas = function (_a) {
  var children = _a.children,
    ...
    userId = _a.userId,
    initialStyle = _a.initialStyle,
    pointerEvents = _a.pointerEvents,
    width = _a.width,
    height = _a.height,
    cssWidth = _a.cssWidth,
    cssHeight = _a.cssHeight,
    display = _a.display;
  var _b = useState(),
    canvas = _b[0],
    setCanvas = _b[1];
  ...
  var _f = useContext(WhiteboardContext),
    text = _f.text,
    brushIsActive = _f.brushIsActive,
    textIsActive = _f.textIsActive,
    shapeIsActive = _f.shapeIsActive,
    fontFamily = _f.fontFamily,
    updateFontFamily = _f.updateFontFamily,
    fontColor = _f.fontColor,
    updateFontColor = _f.updateFontColor,
    penColor = _f.penColor,
    isLocalObject = _f.isLocalObject,
    eraseType = _f.eraseType,
    shape = _f.shape,
    shapeColor = _f.shapeColor,
    lineWidth = _f.lineWidth,
    updateCanvasActions = _f.updateCanvasActions,
    shapesAreSelectable = _f.shapesAreSelectable,
    shapesAreEvented = _f.shapesAreEvented,
    eventedObjects = _f.eventedObjects,
    floodFillIsActive = _f.floodFillIsActive,
    updatePenColor = _f.updatePenColor,
    updateLineWidth = _f.updateLineWidth,
    updateShape = _f.updateShape,
    updateShapeColor = _f.updateShapeColor,
    floodFill = _f.floodFill,
    laserIsActive = _f.laserIsActive,
    allowPointer = _f.allowPointer,
    universalPermits = _f.universalPermits,
    toolbarIsEnabled = _f.toolbarIsEnabled,
    setToolbarIsEnabled = _f.setToolbarIsEnabled;
  var _g = useCanvasActions(
      canvas,
      undoRedoDispatch,
      instanceId,
      eventSerializer,
  ...
  useEffect(
    function () {
      ...
      var wrapper =
        lowerCanvas === null || lowerCanvas === void 0
          ? void 0
          : lowerCanvas.parentElement;
      var upperCanvas =
        wrapper === null || wrapper === void 0
          ? void 0
          : wrapper.getElementsByClassName('upper-canvas')[0];
      if (wrapper) {
        setWrapper(wrapper);
      ...
      if (lowerCanvas) setLowerCanvas(lowerCanvas);
      if (upperCanvas) setUpperCanvas(upperCanvas);
    },
    [canvas, instanceId]
  );
  /**
