...
export var WhiteboardCanvas = function (_a) {
    var children = _a.children, instanceId = _a.instanceId, userId = _a.userId, initialStyle = _a.initialStyle, pointerEvents = _a.pointerEvents, width = _a.width, height = _a.height, cssWidth = _a.cssWidth, cssHeight = _a.cssHeight, display = _a.display;
    ...
    useSynchronizedSetToolbarPermissions(userId, filterIncomingEvents, setToolbarIsEnabled);
