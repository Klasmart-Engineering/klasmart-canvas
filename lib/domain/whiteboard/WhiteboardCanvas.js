...
export var WhiteboardCanvas = function (_a) {
    ...
    return (React.createElement("div", { tabIndex: 0, onKeyDown: keyDown, style: { backgroundColor: 'transparent ' } },
        React.createElement("canvas", { width: width, height: height, id: instanceId, style: initialStyle, tabIndex: 0, onClick: function () {
                actions.addShape(shape);
            } }, children)));
};
