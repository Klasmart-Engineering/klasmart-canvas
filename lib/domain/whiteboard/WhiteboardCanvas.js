...
export var WhiteboardCanvas = function (_a) {
    var children = _a.children, instanceId = _a.instanceId, userId = _a.userId, initialStyle = _a.initialStyle, pointerEvents = _a.pointerEvents, width = _a.width, height = _a.height, cssWidth = _a.cssWidth, cssHeight = _a.cssHeight, filterUsers = _a.filterUsers;
    ...
    var _f = useSharedEventSerializer().state, eventSerializer = _f.eventSerializer, eventController = _f.eventController;
    var _g = useContext(WhiteboardContext), brushIsActive = _g.brushIsActive, textIsActive = _g.textIsActive, shapeIsActive = _g.shapeIsActive, fontFamily = _g.fontFamily, updateFontFamily = _g.updateFontFamily, fontColor = _g.fontColor, updateFontColor = _g.updateFontColor, penColor = _g.penColor, isLocalObject = _g.isLocalObject, eraseType = _g.eraseType, shape = _g.shape, shapeColor = _g.shapeColor, updateCanvasActions = _g.updateCanvasActions;
    var _h = useCanvasActions(canvas), actions = _h.actions, mouseDown = _h.mouseDown;
    /**
