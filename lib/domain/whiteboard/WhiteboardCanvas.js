...
export var WhiteboardCanvas = function (_a) {
    ...
    var _g = useSharedEventSerializer(), eventSerializer = _g.state.eventSerializer, requestAllEvents = _g.requestAllEvents;
    var undoRedoDispatch = UndoRedo(canvas, eventSerializer, userId).dispatch;
    var _h = useContext(WhiteboardContext), text = _h.text, brushIsActive = _h.brushIsActive, textIsActive = _h.textIsActive, shapeIsActive = _h.shapeIsActive, fontFamily = _h.fontFamily, updateFontFamily = _h.updateFontFamily, fontColor = _h.fontColor, updateFontColor = _h.updateFontColor, penColor = _h.penColor, isLocalObject = _h.isLocalObject, eraseType = _h.eraseType, shape = _h.shape, shapeColor = _h.shapeColor, lineWidth = _h.lineWidth, updateCanvasActions = _h.updateCanvasActions, shapesAreSelectable = _h.shapesAreSelectable, shapesAreEvented = _h.shapesAreEvented, eventedObjects = _h.eventedObjects, floodFillIsActive = _h.floodFillIsActive, updatePenColor = _h.updatePenColor, updateLineWidth = _h.updateLineWidth, updateShape = _h.updateShape, updateShapeColor = _h.updateShapeColor, floodFill = _h.floodFill, laserIsActive = _h.laserIsActive, allowPointer = _h.allowPointer, universalPermits = _h.universalPermits, toolbarIsEnabled = _h.toolbarIsEnabled, setToolbarIsEnabled = _h.setToolbarIsEnabled;
    var _j = useCanvasActions(canvas, undoRedoDispatch, instanceId, eventSerializer, userId), actions = _j.actions, mouseDown = _j.mouseDown;
    /**
