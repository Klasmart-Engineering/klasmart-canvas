...
var reducer = function (state, action) {
    ...
    switch (action.type) {
        ...
        case SET: {
            ...
            var states = __spreadArray([], state.states, true);
            var events = __spreadArray([], state.events, true);
            ...
            var currentState = objectStringifier(__spreadArray(__spreadArray([], selfItems, true), otherObjects, true));
            ...
            states = __spreadArray(__spreadArray([], states, true), [mappedSelfState], false);
            ...
            if (action.event && !Array.isArray(action.event)) {
                events = __spreadArray(__spreadArray([], events, true), [action.event], false);
                ...
                events = __spreadArray(__spreadArray([], events, true), action.event, true);
                stateItems = __assign(__assign({}, stateItems), { events: events, eventIndex: events.length - 1 });
            }
            return stateItems;
        }
        case SET_GROUP: {
            ...
            var currentState = JSON.stringify({
                objects: __spreadArray(__spreadArray([], selfItems, true), otherObjects, true),
            });
            // This block removed future states if a new event has
            // been created after an undo.
            if (state.activeStateIndex !== null &&
            ...
            if (Array.isArray(action.event)) {
                ...
                events = __spreadArray(__spreadArray([], events, true), [newEvent], false);
            }
            stateItems = __assign(__assign({}, stateItems), { events: events, eventIndex: events.length - 1 });
            return stateItems;
        }
        ...
        case UNDO: {
            ...
            var activeState = JSON.stringify({
                objects: __spreadArray(__spreadArray([], activeSelfStateObjects, true), otherStateObjects, true),
            });
            var newState = __assign(__assign({}, state), { actionType: UNDO, activeStateIndex: activeStateIndex, activeState: activeState, eventIndex: eventIndex });
            return newState;
        }
        ...
        case REDO: {
            ...
            return __assign(__assign({}, state), { actionType: REDO, activeStateIndex: activeStateIndex, activeState: activeState, eventIndex: eventIndex });
        }
