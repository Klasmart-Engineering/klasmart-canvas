...
export var useCanvasActions = function (canvas) {
    var _a = useContext(WhiteboardContext), shapeIsActive = _a.shapeIsActive, updateFontColor = _a.updateFontColor, shape = _a.shape, shapeColor = _a.shapeColor, updatePenColor = _a.updatePenColor, updateShapeColor = _a.updateShapeColor, closeModal = _a.closeModal, setCircleSize = _a.setCircleSize, setSize = _a.setSize, setPathSize = _a.setPathSize, penColor = _a.penColor, lineWidth = _a.lineWidth, shapeToAdd = _a.shapeToAdd;
    /**
     ...
     * */
    var addShape = useCallback(function (_specific) {
        ...
        clearOnMouseEvent();
        clearMouseEvents();
        mouseDown(shapeToAdd, shapeToAdd.startsWith('filled') ? shapeColor : penColor);
    }, [
        clearMouseEvents,
        clearOnMouseEvent,
        mouseDown,
    ...
    var changeStrokeColor = useCallback(function (color) {
        ...
        var activeObjects = (_a = canvas) === null || _a === void 0 ? void 0 : _a.getActiveObjects();
        if (!activeObjects)
            return;
